...
interface ServiceInterface {
    ...
    */
     ...
     * @param string|null $messageClass The message class to instantiate if message is null. Required if `$message` is null, otherwise irrelevant.
     * @return $this
     */
    public function setMessage(?MessageInterface $message = null, ?string $messageClass = null): self;
