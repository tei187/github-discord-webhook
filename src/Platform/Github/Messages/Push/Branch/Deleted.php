...
class Deleted extends MessageAbstract {
    ...
    protected function create(): void {
        $this->message = "Branch **\"{$this->webhook->payload->repo->branch}\"** deleted from **[{$this->webhook->payload->repo->fullname}](https://github.com/{$this->webhook->payload->repo->fullname})**"
